...
<div id="index">
    <div id="head">
        <div class="head-flex">
          <img src="img\title-img.jpg" alt="">
          <h1>TURIBITO</h1>
        </div>
        <ul>
          <a href="#form"><li>投稿する</li></a>
          <a href="#post-head"><li>みんなの釣果</li></a>
    ...
    <div id="content">
        <form id="form" action="" method="post" enctype="multipart/form-data">
                ...
                <div class="post-content">
                    ...
                    <input type = "text" name = "fishName" placeholder="例：ブラックバス" value="<?php echo h($fishName,ENT_QUOTES); ?>">
                ...
                <div class="post-content">
                    ...
                    <input type = "number" name = "size" placeholder="cm" value="<?php echo h($size,ENT_QUOTES); ?>">
